...
CREATE TABLE IF NOT EXISTS `world_bank_data`.`data_3_years_avg` (
  `country_code` VARCHAR(3) NOT NULL,
  `AG.LND.FRST.ZS` FLOAT NULL,
  `SH.XPD.CHEX.GD.ZS` FLOAT NULL,
  `EG.ELC.ACCS.ZS` FLOAT NULL,
...
CREATE TABLE IF NOT EXISTS `world_bank_data`.`data_5_years_avg` (
  `country_code` VARCHAR(3) NOT NULL,
  `AG.LND.FRST.ZS` FLOAT NULL,
  `SH.XPD.CHEX.GD.ZS` FLOAT NULL,
  `EG.ELC.ACCS.ZS` FLOAT NULL,
...
CREATE TABLE IF NOT EXISTS `world_bank_data`.`data_10_years_avg` (
  `country_code` VARCHAR(3) NOT NULL,
  `AG.LND.FRST.ZS` FLOAT NULL,
  `SH.XPD.CHEX.GD.ZS` FLOAT NULL,
  `EG.ELC.ACCS.ZS` FLOAT NULL,
